...
fn main() {
    ...
    println!("raiz quadradada de 25: {}", 25f64.sqrt());
    println!("raiz cúbica de 27: {}", 27f64.cbrt());
    ...
    println!("seno 3.14: {}", 3.14f64.sin());
    println!("cosseno 3.14: {}", 3.14f64.cos());
